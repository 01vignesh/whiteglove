...
if (!function_exists('render_provider_page_start')) {
    function render_provider_page_start(string $title, string $backHref = '/WhiteGlove/public/provider_hub.php', string $backLabel = 'Provider Hub'): void
    {
...
if (!function_exists('render_provider_page_end')) {
    function render_provider_page_end(string $suiteLabel = 'Provider Operations Suite'): void
    {
