...
if (!function_exists('render_admin_module_page_start')) {
    function render_admin_module_page_start(
        string $title,
        string $backHref = '/WhiteGlove/public/admin_hub.php',
        string $backLabel = 'Admin Hub'
    ): void {
        ...
        echo '            <a class="btn-modern btn-modern-line" href="/WhiteGlove/public/dashboard.php">Dashboard</a>';
...
if (!function_exists('render_admin_module_page_end')) {
    function render_admin_module_page_end(string $suiteLabel = 'Admin Operations Suite'): void
    {
